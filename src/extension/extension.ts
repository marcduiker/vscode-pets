...
const ALL_PETS = [PetType.cat, PetType.clippy, PetType.dog, PetType.rubberduck, PetType.snake, PetType.totoro, PetType.crab, PetType.zappy, PetType.rocky];
...
function normalizeColor(petColor: PetColor, petType: PetType): PetColor {
	...
	if (petType === PetType.crab)
		{return PetColor.red;}
	if (petType === PetType.rocky)
		{return PetColor.gray;}
	if (petType === PetType.zappy)
		{return PetColor.yellow;}
